...
<form method="get" class="form-inline pb-3 editButton">
  ...
  <button type="submit" class="btn btn-outline-success mr-2" name="submit" value="updateFlavor"><i class="fa fa-floppy-o" aria-hidden="true"></i></button>
  <button type="submit" class="btn btn-outline-danger mr-2" name="submit" value="removeFlavor"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
  </form>
