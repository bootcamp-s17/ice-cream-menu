...
--
-- Name: item_types; Type: TABLE; Schema: public; Owner: josh
--
...
ALTER TABLE item_types OWNER TO josh;

--
-- Name: item_types_id_seq; Type: SEQUENCE; Schema: public; Owner: josh
--
...
ALTER TABLE item_types_id_seq OWNER TO josh;

--
-- Name: item_types_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: josh
--
...
--
-- Name: menu_items; Type: TABLE; Schema: public; Owner: josh
--
...
ALTER TABLE menu_items OWNER TO josh;

--
-- Name: menu_items_id_seq; Type: SEQUENCE; Schema: public; Owner: josh
--
...
ALTER TABLE menu_items_id_seq OWNER TO josh;

--
-- Name: menu_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: josh
--
...
--
-- Name: item_types id; Type: DEFAULT; Schema: public; Owner: josh
--
...
--
-- Name: menu_items id; Type: DEFAULT; Schema: public; Owner: josh
--
...
--
-- Data for Name: item_types; Type: TABLE DATA; Schema: public; Owner: josh
--
...
--
-- Name: item_types_id_seq; Type: SEQUENCE SET; Schema: public; Owner: josh
--
...
--
-- Data for Name: menu_items; Type: TABLE DATA; Schema: public; Owner: josh
--
...
--
-- Name: menu_items_id_seq; Type: SEQUENCE SET; Schema: public; Owner: josh
--
...
--
-- Name: item_types item_types_pkey; Type: CONSTRAINT; Schema: public; Owner: josh
--
...
--
-- Name: menu_items menu_items_pkey; Type: CONSTRAINT; Schema: public; Owner: josh
--
...
--
-- Name: menu_items menu_items_item_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: josh
--
